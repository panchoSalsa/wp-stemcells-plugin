...
class OptionIndexes extends WpSolrExtensions {
	...
	public function get_index_search_engine( $solr_index ) {
		...
		return $this->get_index_property( $solr_index, WPSolrAbstractEngineClient::ENGINE, WPSolrAbstractEngineClient::ENGINE_SOLR );
	}

	public function get_index_search_engine_name( $solr_index ) {

		return WPSolrAbstractEngineClient::ENGINE_SOLR === $this->get_index_search_engine( $solr_index ) ? WPSolrAbstractEngineClient::ENGINE_SOLR_NAME : WPSolrAbstractEngineClient::ENGINE_ELASTICSEARCH_NAME;
	}
	...
	public function build_config( &$solr_index_indice = null, $language_code = null, $timeout ) {
		...
		$config = array(
			'index_engine' => isset( $solr_index['index_engine'] ) ? $solr_index['index_engine'] : WPSolrAbstractEngineClient::ENGINE_SOLR,
